...
#ifndef TASKS_TASK_3_SAFAROV_N_INT_RADIX_SORT_SIMPLE_MERGE_H_
#define TASKS_TASK_3_SAFAROV_N_INT_RADIX_SORT_SIMPLE_MERGE_H_
...
#endif  // TASKS_TASK_3_SAFAROV_N_INT_RADIX_SORT_SIMPLE_MERGE_H_
