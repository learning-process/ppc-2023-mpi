...
std::vector<int> randomVector(std::vector<int>& vec, int size, int minElem = -100, int maxElem = 100);
std::vector<int> randomMatrix(std::vector<int>& matrix, int rows, int cols, int minElem = -100, int maxElem = 100);
