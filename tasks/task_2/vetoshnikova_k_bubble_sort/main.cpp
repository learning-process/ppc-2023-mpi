...
TEST(Parallel_Bubble_sort, Test_arr_1) {
    ...
    std::vector<int> arr_original{ 0, 6, 3, 8, 1, 5, 4 };
    std::vector<int> arrPar(count_size_vector);
    std::vector<int> arrSeq(count_size_vector);
...
TEST(Parallel_Bubble_sort, Test_random_arr_1) {
    ...
    std::vector<int> arr_original = array_generation(5, 100, count_size_vector);
    std::vector<int> arrPar(count_size_vector);
    std::vector<int> arrSeq(count_size_vector);
...
TEST(Parallel_Bubble_sort, Test_negative_elements) {
    ...
    std::vector<int> arr_original = array_generation(-100, 0, count_size_vector);
    std::vector<int> arrPar(count_size_vector);
    std::vector<int> arrSeq(count_size_vector);
...
TEST(Parallel_Bubble_sort, Test_random_arr_2) {
    ...
    std::vector<int> arr_original = array_generation(-50, 50, count_size_vector);
    std::vector<int> arrPar(count_size_vector);
    std::vector<int> arrSeq(count_size_vector);
...
TEST(Parallel_Bubble_sort, Test_arr_2) {
    ...
    std::vector<int> arr_original{ 20, 17, 14, 11, 8, 5, 2, -1, -4, -7 };
    std::vector<int> arrPar(count_size_vector);
    std::vector<int> arrSeq(count_size_vector);
